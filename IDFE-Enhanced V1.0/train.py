...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=r"Basic weights_training must be loaded.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default=r"models/IDFE-Net-Enhanced version2.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=r"data/GCD-Part-1.yaml.yaml", help="dataset.yaml path")
