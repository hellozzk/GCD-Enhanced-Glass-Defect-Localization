...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=r"models/IDFE-Net-Enhanced version.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=r"data/bot.yaml", help="dataset.yaml path")
